...
describe("[Challenge] The rewarder", function () {
  ...
  before(async function () {
    ...
    const TheRewarderAttackerFactory = await ethers.getContractFactory(
      "TheRewarderAttacker",
      deployer
    );
    ...
    this.TheRewarderAttacker = await TheRewarderAttackerFactory.deploy();
  ...
  it("Exploit", async function () {
    ...
    await this.TheRewarderAttacker.attack(
      this.flashLoanPool.address,
